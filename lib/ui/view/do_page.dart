...
import 'package:chlcov/ui/widgets/card_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          'Berikut adalah beberapa informasi bantahan terhadap HOAX yang beredar yang telah dikonfirmasi oleh Humas POLRI. Bagikan informasi ini dan dapatkan chlcov-Poin!',
          style: TextStyle(
            fontFamily: 'Poppins',
            fontWeight: FontWeight.w400,
            fontSize: 12,
